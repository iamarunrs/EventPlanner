...
<!-- contact -->	
	...
	<h2 class="heading-agileinfo">Contact<span>Events is a professionally managed Event</span></h2>
		<div class="map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d15800.0286745036!2d77.44332645058593!3d8.100749936215763!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwMDYnMDUuMSJOIDc3wrAyNiczNC45IkU!5e0!3m2!1sen!2sin!4v1697361291851!5m2!1sen!2sin"></iframe>
		</div>
		<div class="col-md-6 contact-form">
				<h4 class="white-w3ls">Feedback Form</h4>
				<form action="feedback.php" method="post" enctype="multipart/form-data">
					...
					<div class="styled-input">
						<input type="date" name="EventDate" required="" style="color:transparent;" placeholder="" min="<?php echo date('Y-m-d', strtotime('-4 years')); ?>"
			...
			<div class="col-md-6 contactright">
				...
				<div class="w3ls_footer_grid_left">
					...
					<p>19th Street, NGL City, TN State, <span>NGL City 629601</span></p>
				</div>
				<div class="w3ls_footer_grid_left">
					<div class="wthree_footer_grid_left">
				...
				<div class="w3ls_footer_grid_left">
					<div class="wthree_footer_grid_left">
						...
						<span><a href="mailto:iamarun.rs@gmail.com">iamarun.rs@gmail.com</a></span></p>
				</div>
			</div>
