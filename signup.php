	...
	<div class="about">
		...
		<h2><center>Sign UP</center></h2>
			<form action="signupform.php" method="post">
				<input type="text" name="name" id="Name" placeholder="Name" required style="width:100%; padding:10px; margin:10px 0; ">
                <input type="email" name="username" id="Email" placeholder="Email" required style="width:100%; padding:10px; margin:10px 0; ">
                <input type="password" name="password" id="Pass" placeholder="Password" required style="width:100%; padding: 10px; margin: 10px 0; ">
                <input type="password" name="confirmpassword" id="Confirm" placeholder="Confirm Password" required style="width:100%; padding: 10px; margin: 10px 0; ">
